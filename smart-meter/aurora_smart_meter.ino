...
const String USER_ID = "default-user"; //can be used interchangeably with smart_meter_id on header request
...
bool sendDataToBackend() {
  ...
  http.addHeader("x-user-id", SMART_METER_ID);  // This should be configurable per installation
