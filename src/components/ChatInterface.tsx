          ...
          <div className="flex-1 overflow-y-auto p-2 md:p-4 space-y-3 md:space-y-4">
            {messages.map((message) => (
              ...
              >
                ...
                <div
                  className={`max-w-[85%] md:max-w-[80%] p-2 md:p-3 rounded-lg text-xs md:text-sm break-words ${
                    message.isBot
                    ...
                    <div className="prose prose-sm prose-invert max-w-none">
                      <ReactMarkdown
                        components={{
                          ...
                          h1: ({ children }) => <h1 className="text-base md:text-lg font-bold mb-2 text-aurora-green-light">{children}</h1>,
                          h2: ({ children }) => <h2 className="text-sm md:text-base font-bold mb-2 text-aurora-green-light">{children}</h2>,
                          h3: ({ children }) => <h3 className="text-xs md:text-sm font-bold mb-1 text-aurora-green-light">{children}</h3>,
