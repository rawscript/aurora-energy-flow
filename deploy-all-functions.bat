@echo off
REM Script to deploy all Supabase Edge Functions on Windows

echo Deploying all Supabase Edge Functions...

REM Deploy profile functions
...
REM Deploy notification functions
