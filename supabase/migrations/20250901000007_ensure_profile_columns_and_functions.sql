-- Ensure all required profile columns exist and functions are properly defined
-- This migration fixes issues with missing columns and functions that cause 404 errors
...
-- Ensure the get_or_create_profile function exists and is properly defined
...
-- Ensure the safe_update_profile function exists and is properly defined
...
-- Ensure the get_notification_preferences function exists
...
-- Ensure the initialize_user_notifications function exists
...
-- Ensure the get_user_notifications_safe function exists
...
-- Ensure the get_token_analytics_cached function exists
...
-- Ensure the get_token_transactions_cached function exists
